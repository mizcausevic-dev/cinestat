...
### Released
- Published **cinestat** as a public, portfolio-grade enterprise software operations system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **cinestat**.
...
- That insight became the basis for **cinestat**.
